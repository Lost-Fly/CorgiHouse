...
public class regexConstants {
    ...
    public static final String FORBIDDEN_WORDS_REGEX_ = String.format("^(?:(?!%s).){1,100}$", FORBIDDEN_WORDS);
    public static final String FORBIDDEN_WORDS_REGEX = String.format("(?i)^(?:(?!%s).)*$", FORBIDDEN_WORDS);
