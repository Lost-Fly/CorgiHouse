    ...
    public void onUpdateReceived(Update update) {
        ...
        if (update.hasMessage() && Objects.equals(sessionRepository.findByChatId(chatId).getGlobalFunctionContext(), GLOBAL_CONTEXT_DEFAULT)) {
            ...
            switch (sessionRepository.findByChatId(chatId).getGlobalFunctionContext()) {
                ...
                case GLOBAL_CONTEXT_MEETING_DELETE ->
                        sendMessage(chatId, meetingFuncs.deleteMeeting(chatId, messageText));
                case GLOBAL_CONTEXT_MEETING_REGISTRATION ->
                        sendMessage(chatId, meetingRegistration.continueRegistration(update));
                case GLOBAL_CONTEXT_MEETING_SELECT_NUMBER_MEETING ->
                        sendMessage(chatId, meetingFuncs.editMeetingNameField(chatId, messageText), listMenus.meetingEditKeyboard());
                case GLOBAL_CONTEXT_SET_NAME_FIELD_MEETING ->
                        sendMessage(chatId, meetingFuncs.editMeetingAction(chatId, messageText));
                default -> {
